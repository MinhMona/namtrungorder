<%@ Page Title="" Language="C#" MasterPageFile="~/NamTrungMaster.Master" AutoEventWireup="true" CodeBehind="cong-cu.aspx.cs" Inherits="NHST.cong_cu1" %>
            ...
            <div class="all">
                ...
                <div class="order-tool clearfix">
                    ...
                    <div class="order-tool-right">
                        <h3 class="order-title">ADDON Nhập Hàng TQ SẼ GIÚP BẠN:</h3>
                        ...
                        <div class="tool-setting">
                            <a href="https://chrome.google.com/webstore/detail/c%C3%B4ng-c%E1%BB%A5-%C4%91%E1%BA%B7t-h%C3%A0ng-c%E1%BB%A7a-nh%E1%BA%ADp/bjjkjhapbkfmldkecdelhifaalbcepdo" target="_blank">
