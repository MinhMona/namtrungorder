        ...
        protected void btngetpass_Click(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                if (kq == "1")
                {
                    try
                    {
                        PJUtils.SendMailGmail("Kd.namtrung@gmail.com", "ugkqejxkyhbppdkz", txtEmail.Text.Trim(),
                            "Reset Mật khẩu trên Nam Trung",
                            "Mật khẩu mới của bạn trên hệ thống Nhập Hàng TQ: <strong>" + password
                            + "</strong>", "");
                    }
                    catch
                    {
