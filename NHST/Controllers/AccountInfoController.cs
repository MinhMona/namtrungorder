...
namespace NHST.Controllers
{
    ...
    {        
        ...
        #endregion
        public static tbl_AccountInfo GetByPhoneAndUID(string phone, int UID)
        {
            using (var dbe = new NHSTEntities())
            {
                tbl_AccountInfo acc = dbe.tbl_AccountInfo.Where(a => a.Phone == phone && a.UID == UID).FirstOrDefault();
                if (acc != null)
                    return acc;
                else
                    return null;
        ...
        public static tbl_AccountInfo GetByUID(int UID)
        {
            using (var dbe = new NHSTEntities())
            {
                tbl_AccountInfo acc = dbe.tbl_AccountInfo.Where(a => a.UID == UID).FirstOrDefault();
                if (acc != null)
                    return acc;
                else
                    return null;
