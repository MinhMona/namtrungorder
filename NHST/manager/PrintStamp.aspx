                                        ...
                                        <div class="form-rowm marbot2">
                                            <div style="width: 340px; height: 189px; margin-top: 20px;" id="printcontent">
                                                <div class="stamp-row">
                                                    ...
                                                    <span class="label-text font-size-25" style="font-size:30px;font-weight:bold;">
                                                ...
                                                <div class="stamp-row">
                                                    ...
                                                    <span class="label-text">
                                                        <asp:Label ID="lblProductCount" runat="server"></asp:Label></span>
                                                </div>
                                                <div class="stamp-row">
                                                ...
                                                <div class="stamp-row">
                                                    <span class="label-print">Về kho: </span>
                                                    <span class="label-text">
                                                        <asp:Label ID="lblReceivePlace" runat="server"></asp:Label></span>
                                                </div>
                                                <div class="stamp-row">
