<%@ Page Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="push-noti-app-user.aspx.cs" Inherits="NHST.manager.push_noti_app_user" %>
                                ...
                                <div class="cont">
                                    <div class="inner">
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:TextBox runat="server" ID="txtUsername" Enabled="true" CssClass="form-control"></asp:TextBox>
                                        </div>
