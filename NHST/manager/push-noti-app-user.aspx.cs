            ...
            if (acc != null)
            {
                ...
                if (kq != null)
                {
                    ...
                    if (l != null)
                    {
                        ...
                        {
                            string link = "http://namtrungorder.com/danh-sach-thong-bao-app.aspx?UID=" + acc.ID + "&Key=" + item.UserToken + "";
            ...
            try
            {
                ...
                var objNotificationiOS = new
                {
                    ...
                    data = new
                    {
                        title = title,
                        message = Noti,
                        image = "http://demo.namtrungorder.com/App_Themes/vominhthien/images/main-logo.png",
                        link = link
