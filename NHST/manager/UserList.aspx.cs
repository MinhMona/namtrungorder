    ...
    public partial class UserList : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if (ac.RoleID == 0)
            {
                ...
                StrExport.Append("      <th><strong>Tỉ giá riêng</strong></th>");
                StrExport.Append("      <th><strong>Phí mua hàng riêng (tiền VNĐ)</strong></th>");
                StrExport.Append("      <th><strong>Phí cân nặng riêng (tiền VNĐ/kg)</strong></th>");
