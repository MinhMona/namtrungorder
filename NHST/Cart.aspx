<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterNew.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="NHST.Cart1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="primary-form custom-width">
                    <div class="order-tool clearfix">
                        <div class="tool-detail">
                            <div class="sec step-sec custom-width-50">
                                <div class="steps">
                            ...
                            <div class="sec warning-sec custom-width-50">
                                <div class="sec-tt">
                                ...
                                <p class="warning-txt">
                                    Sản phẩm trong giỏ sẽ tự động xóa trong vòng 30 ngày. Người bán trên website 1688.com thường có quy định về số lượng mua tối thiểu, bội số mỗi sản phẩm, giá trị đơn hàng 
                                            tối thiểu và sẽ từ chối bán nếu không đáp ứng. Trong trường hợp đó Nhập Hàng TQ sẽ hủy những đơn hàng này và không báo trước.
                                </p>
                                <div class="clear"></div>
                            </div>
                            <div class="sec gray-area" style="display: none">
                                <div class="sec-tt">
                                ...
                                <asp:UpdatePanel ID="upd" runat="server">
                                    <ContentTemplate>
                                        <div class="search-url-box">
                                            ...
                                            <asp:Button ID="btn_search" runat="server" CssClass="pill-btn btn btn-search btn main-btn hover" Text="Tìm thông tin sản phẩm" OnClick="btn_search_Click" Style="width: 24%;" />
                                ...
                                <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="upd">
                                    <ProgressTemplate>
                                        <div class="modal">
                                            <div class="center">
                                                <img alt="" src="/App_Themes/AdminNew/loading.gif" width="80px" />
                                            </div>
                                        </div>
                                    </ProgressTemplate>
                                </asp:UpdateProgress>
                                ...
                                <div class="search-internal-box">
                                    ...
                                    <a class="pill-btn btn btn main-btn hover btn-1" onclick="add_to_cart();" style="font-size: 13px; width: 24%;">Thêm vào giỏ hàng</a>
                                </div>
                            </div>
                            <div class="sec table-price-sec" style="margin-top: 20px; display: inline-block; padding: 20px; background: #fff;">
                                <div class="tbp-top">
    ...
    <script type="text/javascript">
        ...
        function updatequantity(ID, obj, shopid) {
            ...
            var brand = obj.parent().parent().find(".notebrand").val();
            if (quantity == 0) {
                deleteordertemp(ID, shopid);
            }
            else {
